...
<body>
	...
	<%-- JSP  주석 : 소스보기에서 확인 불가능, 빈 줄(line)으로 나타난다. --%>
	...
	<!-- ★ 4. 표현식 (Expression) : 값( 변수, 메소드 호출 결과)을 나타낼 때 사용 -->
	<div><%=sum%></div>
	...
	<!--
		...
		<select name = "month">
			...
			<option value = "1">1월 선택</option>
			...
			<option value = "12">12월 선택</option>
		</select>
	 -->
	 <div>
		 <select name = "month">
