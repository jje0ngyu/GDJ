...
public class Main {
	...
	public static void m1() {
		System.out.println("=== String 타입의 URL 메소드 ===");
		System.out.println("=== 예외 : MalformedURLException ===");
	...
	public static void m2() {
		...
		// 1. 웹 접속을 담당하는 클래스
		// 2. URL 클래스와 함께 사용
		// 3. URLConnectoion 클래스의 자식 클래스
		// 4. URLConnection 클래스의 openConnection() 메소드를 호출해서 HttpURLConnection 클래스 타입으로 저장
		// 		 >* 즉, URLConnection 을 서브클래스인 HttpURLConnection 으로 저장 (다운캐스팅 필요) 
		
		//* 부모의 메소드를 호출하지만 실제 저장은 자신에게.
