...
public class Main {
	...
	public static void main(String[] args) {
		...
		// 한 대씩 주고 받기
		// 두 유닛이 모두 살아있으면 계속 싸움 (*하나라도 죽어 있으면 게임 끝)
		while (unit1.isAlive() && unit2.isAlive()) {	// while(unit1.getEnergy() > 0 && unit2.getEnergy() > 0) *에너지 > 0 생존
			if(myTurn) {
				...
				unit2.attack(unit1); // unit2이  unit1을 공격한다. (마린은 40% 확률로 상대를 한 번에 죽인다.)
			}
