...
public class Ex02 {
	...
	public static void main(String[] args) {
		...
		// 논리 OR  : || (shift+\,백스페이스바 옆 키), 하나라도 true이면 true / 모두 false이면 false
		// 논리 NOT : !, true는 false/ false는 true
		
		int a = 10;
		int b = 10;
		
		// 2가지 이상의 조건문이 있을 경우, ()로 묶어줄 것(권장)
		...
		System.out.println(j);       // 11이 아니라 10 (앞의 조건문에 false가 발생하여 진행하지 않음)
		
		boolean result10 = ( i == 10) || (++j == 11);
		System.out.println(result10); // true
		System.out.println(j);        // 11이 아니라 10 (앞의 조건문에 true가 발생하여 진행하지 않음)
