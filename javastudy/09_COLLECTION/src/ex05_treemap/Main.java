...
public class Main {
	...
	public static void m1() {
		...
		System.out.println("=== 작은 값부터 큰 값으로 정렬하는 TreeMap 입니다. ===");
		...
		System.out.println(map);	// key를 기준으로 정렬
	...
	public static void m2() {
		...
		System.out.println("=== 오름차순(기본) >>> 내림차순으로 변경한 descendingMap 입니다. ===");
		...
		// 오름차순 정렬 ⇔ 내림차순 정렬	//* 내림차순으로 무조건 되는 것이 아니라, 오름차순이면 내림차순으로. 내림차순이면 오름차순으로 변경한다는 의미
