...
public class Main {
	...
	public static void m1() {
		...
		// 삭제된 Value가 반환
		String removeItem = dictionary.remove("tomato"); //* key값을 입력 , value입력시 null 반환
		System.out.println(removeItem);	// Value값인 "토마토"가 반환
		...
		// 확인
		System.out.println(dictionary);	//* 중괄호{} 로 묶여서 출력 5개의 데이터가 입력되어 있다. (10개 X)
	...
	public static void m4() {
		...
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();	// (★★) 실무에서 심심치 않게 보이는 타입
		list.add(map1);
		list.add(map2);
		list.add(map3);
