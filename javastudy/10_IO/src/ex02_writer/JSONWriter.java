...
public class JSONWriter {
	...
	public static void m1() {
		...
		System.out.println("=== JSON 데이터 만들어보기 ===");
		// JSON
	...
	public static void m2() {
		System.out.println("=== JSON Array (배열) 사용해보기 ===");
	...
	public static void m3() {
		...
		String name = obj.getString("name"); //* 타입을 불러오는 get 활용
	...
	public static void m4() {
		System.out.println("=== JSONArray 를 JSONObject 로 바꿔 출력하기 ===");
