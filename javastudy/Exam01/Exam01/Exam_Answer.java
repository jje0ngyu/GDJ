...
public class Exam_Answer {
	...
	public static void q1() {
		...
		System.out.println(serial + "은 " + gender + "입니다.");
	}
	...
	public static void q6() {
		...
		for(int count = 1; count <= 10; count++) {
			int withdraw = (int)(Math.random() * 1000) + 1;
			System.out.println("출금 전 " + balance + "원, " + count + "회 출금 " + withdraw + "원, 출금 후 " + (balance -= withdraw) + "원");
		}
	}
