...
public class BoardServiceImpl implements BoardService {
	...
	-----------------------------------------------------------------
		...
		3) HttpSatus status   : 응답 코드(200, 404, 500 등)
	
	 */
	
	
	/* -----------------------------------------------------------------------------------
	ResponseEntity 사용 1 : HttpServletRequest 이용하기 → request.getParameter() 로 받기
	-------------------------------------------------------------------------------------- */
	@Override
	...
	/* --------------------------------------------------------------------------
	ResponseEntity 사용 2 : @RequestParam 이용하기 → HttpHeaders header 로 받기
	----------------------------------------------------------------------------- */
	@Override
	...
	/* ------------------------------------------------------------------
	ResponseEntity 사용 3 : Board 이용하기 → HttpHeaders header 로 받기
	--------------------------------------------------------------------- */
	@Override
