...
-- 프로시저 PROC2 정의
-- 사원번호 = 100 인 사원의 FIRST_NAME 서버메시지로 출력하기
...
-- 프로시저 PROC4 정의
-- 사원번호 = 100 인 사원의 FIRST_NAME을 출력 파라미터 FNAME에 저장하기
